...
def detect_yolov8(params):
    """Detect objects with different versions of YOLOv8.
    ...
    for version in params['versions']:
        ...
        command = f"python {params['yolo_path']}/detect.py --weights {os.getcwd()}/models/yolov8{version}_best.pt --img {params['img_size']} --source {params['data_path']} --project {params['project_name']} --name {params['run_name']}_{version} --save-txt"
