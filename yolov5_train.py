...
def train_yolov5(yolo_path, img_size, batch, epochs, data_path, project_name, run_name, versions):
    ...
    for version in versions:
        ...
        os.system(f'cp {project_name}/{modified_run_name}/weights/best.pt {os.getcwd()}/models/yolov5{version}_best.pt')
...
def main():
    ...
    train_yolov5(yolo_path, img_size, batch, epochs, data_path, project_name, run_name, versions)
