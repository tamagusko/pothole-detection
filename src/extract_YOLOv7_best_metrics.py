# NEED TO BE ADJUSTED FOR THE results.csv columns
...
def main():
    # Model versions
    versions = ['YOLOv7', 'YOLOv7x']

    for version in versions:
        # Form the CSV path for each model
        csv_path = f'/home/t1/repos/pothole-detection/{version}/train_comparison/results.csv'
        
        best_metrics = extract_best_metrics(csv_path)
        print(f"model: {version}, {best_metrics}")
